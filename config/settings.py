...
SECRET_KEY = 'django-insecure-z*#727=r_*u^1z05k#^ga1ah#wc0i-i-hl%4)ihm&#zzigdx6b'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # مسیر تمپلیت‌ها را به درستی تنظیم کنید
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_REDIRECT_URL = 'urgent_post_list'
LOGOUT_REDIRECT_URL = 'urgent_post_list'
